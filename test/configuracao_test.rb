...
describe Superpay::Configuracao do
  ...
  it "deveria configurar corretamente" do
    Superpay.config.teste?.must_equal true
    Superpay.config.producao?.must_equal false
  ...
  it "deveria sobrecarregar os dados configurados" do
    ...
    Superpay.config.teste?.must_equal false
    Superpay.config.producao?.must_equal true
